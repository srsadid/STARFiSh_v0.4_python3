...
#                           'quantitiesOfInterestToProcess']
    ...
    def preprocessSolutionData(self, vascularNetwork, simulationTime, sampleSize, sampleIndex):
        ...
        if "vessel" in self.queryLocation:
            ...
            dataDict = vascularNetwork.getSolutionData(vesselId, list(self.quantitiesOfInterest.keys()), simulationTime, [self.xVal])
            for quantitiyName,quantityObject in self.quantitiesOfInterest.items():
...
#                     
            ...
            dataDict = {}
            for quantitiyName in list(self.quantitiesOfInterest.keys()):
