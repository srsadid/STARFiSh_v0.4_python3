...
#             
    ...
    def writeExtObjectXml(self,externXmlNode, classToWrite, externVariable):
        ...
        for definedClassName, definedClasses in externVariable.classCases.items():
    ...
    def updateHdf5Groups(self, baseGroupName):
        ...
        '''        
        if baseGroupName not in list(self.hdf5File.keys()):
    ...
    def loadDataHdf5(self):
        ...
        for variableName in self.variablesHdf5Memory:
            if variableName in list(self.hdf5Group.keys()): 
        ...
        for dictName in self.objectDictsHdf5Memory:
            ...
            if dictL != {} and dictL != None:
                ...
                if dictName in list(self.hdf5Group.keys()):
                    dictGroup = self.hdf5Group[dictName]
                    for dictObjectName,dictObject in dictL.items():
                        if dictObjectName in list(dictGroup.keys()):
    ...
    def saveDataHdf5(self):
        ...
        for dictName in self.objectDictsHdf5Memory:
            ...
            if dictValue != None or dictValue == {}:
                for dictObjectName,dictObject in dictValue.items():
