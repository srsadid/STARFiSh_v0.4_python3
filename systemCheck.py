...
def systemCheck():
    ...
    try:
        ...
        print(" ... installed via gi.repository.Gtk (Gtk 3)")
    except Exception:
        try:
            import gtk  # legacy PyGTK (Python 2)
            print(" ... installed via legacy pygtk")
        except Exception:
            print(" IMPORT ERROR; no gtk bindings found (install python3-gi / gir1.2-gtk-3.0)")
