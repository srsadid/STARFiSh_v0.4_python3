...
class Visualisation2D(gtk.Window):
    ...
    def __init__(self, networkName = None, dataSetNumber = None, connect = False):
        ...
        if networkName != None:
            ...
            vID = list(self.vascularNetwork.vessels.keys())
    ...
    def on_changedCBvessels(self,widget):
        ...
        if self.vascularNetwork != None:
            ...
            else: self.currentVesselID = list(self.vascularNetwork.vessels.keys())[cbIndex] 
    ...
    def on_changedCBvesselsComparison(self,widget):
        ...
        if self.vascularNetwork != None:
            ...
            else: self.currentVesselIDComparison = list(self.vascularNetwork.vessels.keys())[cbIndex] 
    ...
    def initializeSolutionData(self,networkName, dataSetNumber):
        ...
        self.numberOfVessels = len(list(self.vascularNetwork.vessels.keys()))
