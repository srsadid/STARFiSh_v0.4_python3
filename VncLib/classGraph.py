    ...
    def update_graph(self, vascularNetwork, window):
        ...
        if vascularNetwork != None: 
            ...
            if list(vascularNetwork.vessels.keys()) != []:
                ...
                bcNames = ['?']
                bcTrue = False
                if root in list(vascularNetwork.boundaryConditions.keys()) and vascularNetwork.boundaryConditions[root] != {}:
                        bcNames.pop(0)
                ...
                for endNode in vascularNetwork.boundaryVessels:
                    bcNames = ['?']
                    if endNode in list(vascularNetwork.boundaryConditions.keys()) and vascularNetwork.boundaryConditions[endNode] != {}:
                            bcNames.pop(0)
