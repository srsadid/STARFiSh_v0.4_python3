...
class MeasurementRoutine(TestBaseClass):
    ...
    def adaptationToPatientSpecificCondition(self, vascularNetwork):
        ...
        if self.vesselId not in list(vascularNetwork.vessels.keys()):
        ...
        existingVessels = list(vascularNetwork.vessels.keys())
        ...
        for vesselId,vessel in vascularNetwork.vessels.items():
