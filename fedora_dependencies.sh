...
"${PKG_PREFIX[@]}" dnf -y install gcc
"${PKG_PREFIX[@]}" dnf -y install gcc-gfortran
"${PKG_PREFIX[@]}" dnf -y install gcc-c++
"${PKG_PREFIX[@]}" dnf -y install gtk3
"${PKG_PREFIX[@]}" dnf -y install graphviz
